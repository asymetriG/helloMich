...
public class MainActivity extends AppCompatActivity {
    ...
    private String notAuth = "The supplied auth credential is incorrect, malformed or has expired.";
    ...
    public void loginUser(View view) {
        ...
        if (emailText.isEmpty()) {
            ...
            firebaseAuth.signInWithEmailAndPassword(emailText,passwordText).addOnFailureListener(e -> {
                ...
                Toast.makeText(MainActivity.this,"Logged as : " + firebaseAuth.getCurrentUser().getEmail(),Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MainActivity.this,MainPageActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
